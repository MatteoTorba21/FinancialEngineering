...
%      each row corresponding to a rating 
...
E_FV = Q(1,:)*FV;           %  Present Value in a years' time
...
cumulative_loss_DO = L_D*scen_D;
VaR_DO = quantile(-cumulative_loss_DO,alpha);

% Default and migration case (DM)
cumulative_loss_DM = L_D*scen_D+L_d*scen_d+L_i*scen_i+L_u*scen_u;
VaR_DM =  quantile(-cumulative_loss_DM,alpha);
...
%% Code to plot the results in all cases
% rho = [sqrt(0); sqrt(0.12); sqrt(R_IRB(Q(1,3)));sqrt(0.24)];
% VaR_Def_200 = [1.49;3.88;6.27;7.17];
% VaR_DM_200 = [1.26;4.21;6.94;7.80];
% VaR_Def_20 = [5.98;8.96;8.96;8.96];
% VaR_DM_20 = [5.82;8.74;9.68;9.99];
% plotCorrVSVaR(rho,VaR_Def_200,VaR_DM_200,VaR_Def_20,VaR_DM_20)
